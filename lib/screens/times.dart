...
import 'package:mtqmnuns/viewmodel/prayer_time.dart';
              ...
              : Padding(
                ...
                child: Column(
                  children: [
                    ...
                    const SizedBox(height: 20),
                    Expanded(child: PrayerList(prayerTime: vm.prayerTime!)),
                  ],
                ),
              ),
    );
      ...
      child: Card(
        ...
        child: ListTile(
          leading: Semantics(
            ...
            child: Icon(icon, color: const Color(0xff994EF8), size: 28),
          ),
          title: Text(
            title,
            style: const TextStyle(
